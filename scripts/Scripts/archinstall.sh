...
pacstrap /mnt base base-devel linux linux-firmware neovim sway firejail bemenu qutebrowser alacritty git dash doas htop feh mpv tealdeer keepassxc grub networkmanager pipewire bat nushell trash-cli stow fzf fd
