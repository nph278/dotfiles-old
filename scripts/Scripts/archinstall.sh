...
pacstrap /mnt base base-devel linux linux-firmware neovim sway firejail bemenu firefox-developer-edition alacritty git zsh dash doas htop feh mpv tealdeer keepassxc
cp /root/enter.sh /mnt/root
